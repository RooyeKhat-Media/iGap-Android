...
import net.iGap.R;
import net.iGap.activities.ActivityComment;
    ...
    private void addThreeSubLayoutReplay(final int position, int start, final View itemView) {
        ...
        for (int i = start; i < count && i < 3 + start; i++) {
            ...
            if (infoReplay.senderPicturePath.length() > 0) {
                ...
                imvSenderPictureReplay.setImageBitmap(net.iGap.helper.HelperImageBackColor.drawAlphabetOnPicture((int) context.getResources().getDimension(R.dimen.dp60), infoReplay.senderName, ""));
            }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View itemView, final int position) {
            ...
            if (list.get(position).senderPicturePath.length() > 0) {
                ...
                imvSenderPicture.setImageBitmap(net.iGap.helper.HelperImageBackColor.drawAlphabetOnPicture((int) context.getResources().getDimension(R.dimen.dp60), list.get(position).senderName, ""));
            }
