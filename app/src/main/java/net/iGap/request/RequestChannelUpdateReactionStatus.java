...
public class RequestChannelUpdateReactionStatus {

    public void channelUpdateReactionStatus(long roomId, boolean reactionStatus) {
        ...
        RequestWrapper requestWrapper = new RequestWrapper(426, builder);
        try {
