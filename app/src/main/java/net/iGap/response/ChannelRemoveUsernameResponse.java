...
public class ChannelRemoveUsernameResponse extends MessageHandler {

    public int actionId;
    public Object message;
    public String identity;

    public ChannelRemoveUsernameResponse(int actionId, Object protoClass, String identity) {
    ...
    public void error() {
        ...
        if (G.onChannelRemoveUsername != null) {
            G.onChannelRemoveUsername.onError(majorCode, minorCode);
        }
    }
}
