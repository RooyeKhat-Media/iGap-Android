...
public class TransitionAnimation {
    ...
    public static void startExitAnimation(MoveData moveData, TimeInterpolator interpolator, final Runnable endAction, Animator.AnimatorListener listener) {
        ...
        view.animate().setDuration(duration).scaleX(widthScale).scaleY(heightScale).setInterpolator(interpolator).translationX(leftDelta).setListener(listener).translationY(topDelta);
