...
import com.iGap.request.RequestUserPrivacyGetRule;
import com.iGap.request.RequestUserPrivacySetRule;
...
public class RealmPrivacy extends RealmObject {
    ...
    public static void updatePrivacy(final String avatar, final String channel, final String Group, final String lastSeen) {
